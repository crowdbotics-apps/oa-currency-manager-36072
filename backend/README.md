...
## Project Structure
    ...
    ├── oa_currency_manager_36072  # Django project configurations
...
1. Clone this repo and `cd oa_currency_manager_36072`
...
2. Clone this repo and `cd oa_currency_manager_36072`
